...
try:
    ...
    col1, col2, col3 = st.columns(3)
    daily_change = data['Close'].iloc[-1].values[0] - data['Close'].iloc[-2].values[0]
    col1.metric("Daily Change", str(round(data['Close'].iloc[-1].values[0], 2)), str(round(daily_change, 2)))
